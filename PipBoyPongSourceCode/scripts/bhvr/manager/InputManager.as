package bhvr.manager
{
   ...
   public class InputManager extends EventDispatcher
   {
      ...
      {
        //this._currentPlatform = PlatformChangeEvent.PLATFORM_INVALID; Not needed as we are only developing for PC
        super();
      ...
      {
          /* Check our platform and modify things accordingly. Fuck this for this project, but maybe in the future.
